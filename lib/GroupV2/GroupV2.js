...
class GroupV2 {
	 ...
	 *   @param { module:GroupV2/Enum~chatSecuritySetting } [Options.chatSecurity="ADMINS"] - 
	 */
	async addOptionalConversation( Opts, oAuth ){
		// Lookup the ENUM and use "ADMINS" as the default value
		let enum = await Ml.enumLookup( Opts.chatSecurity, this.Enums.chatSecuritySetting ).catch( e => "ADMINS" );		
