...
class GroupV2 {
	...
	async addOptionalConversation( Opts, oAuth ){
		...
		let enum = await Ml.enumLookup( Opts.chatSecurity, this.Enums.chatSecuritySetting ).catch( e => "undefined" );		
	 ...
	 */
	editOptionalConversation( Opts, oAuth ){
		// Lookup the ENUM and use "undefined" as the default value
		let enum = await Ml.enumLookup( Opts.chatSecurity, this.Enums.chatSecuritySetting ).catch( e => null );
