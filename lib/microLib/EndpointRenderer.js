"use strict"
/**
 * @module EndpointRenderer
 * @exports renderEndpoint
 */
 ...
 */
function renderEndpoint( uri, PathParams = {}, QueryStrings = {} ){
	return new Promise( ( resolve, reject) => {
		...
		Object.keys( PathParams ).forEach( key => {
			// Don't renderEndpoint any undefined values
