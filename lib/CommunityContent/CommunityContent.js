...
class CommunityContent {
	...
	/**
	 * Untested : Returns community content.
	 ...
	 */
	getCommunityContent( mediaFilter, page, sort ){
		Opts.page = ( isNaN( parseInt( page ) ) ) ? 0 : Opts.page;
	...
	/**
	 * Untested - Returns info about community members who are live streaming.
	...
	getCommunityLiveStatuses( Opts ){
		...
		return Promises.all( [
			...
			return Ml.renderEndpoint( this.Endpoints.getCommunityLiveStatuses, {
				// Path params
				page            : Opts.page,
				partnetshipType : Opts.partnershipType,
				sort            : Opts.sort
			}, {
				// Query params
				modeHash : Opts.modeHash,
				streamLocale : Opts.locale
			});
	...
	/**
	 * Untested - Returns info about community members who are live streaming in your clans.
	...
	/**
	 * Untested - Returns info about community members who are live streaming among your friends.
	 * @param { module:CommunityContent/Enum~partnershipType } partnershipType - The type of partnership for which the status should be returned.
	 * @param { module:CommunityContent/Enum~communityStatusSort } sort - The sort mode
	 * @param { number-like } [page=0] - Zero based page
	 */
	...
	/**
	 * Untested - Returns info about Featured live streams.
	 * @param { module:CommunityContent/Enum~partnershipType } partnershipType - The type of partnership for which the status should be returned.
	 * @param { module:CommunityContent/Enum~communityStatusSort } sort - The sort mode
	 * @param { number-like } [page=0] - Zero based page
	 */
