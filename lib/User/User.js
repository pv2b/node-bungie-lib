...
class User{
	...
	constructor( ApiAuth ){
		...
		if( typeof ApiAuth.clientId !== 'string')
			ApiAuth.clientId = "bungie-net-library/" + MicroLib.libVersion + " AppId/null (+https://www.tylermeador.com/bungie-net-library;no-contact-email)"
	...
	async searchUsers( Opts, cb ){
		cb( false, new MicroLib.TypeError( { varName: "Options.search", variable: "THIS_IS_NOT_A_NUM", expected: 'number-like'} ) );
		return;
