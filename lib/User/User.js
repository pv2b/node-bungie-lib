...
class User{
	 ...
	 * @param { callback } callback - The function to be called once the API call has finished
	 ...
	 * @param { callback } callback - The function to be called once the API call is finished
	 ...
	 * @param { callback } callback - A function to be called once the API call is complete
	 ...
	 * @param { callback } - callback - A function to be called once the API call is finished
