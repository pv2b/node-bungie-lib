...
class Destiny2{
	...
	getHistoricalStats( Opts ){
		...
		return Promise.all( [
			...
			return Ml.renderEndpoint( this.Endpoints.getHistoricalStats, {
				...
				groups     : Opts.groups, // How are arrays supposed to be URL encoded?
				modes      : Opts.modes,
	 ...
	 *   @param { ?number-like } [characterId=null] - Destiny character ID, if applicable, that will be affected by the action.
	 * @param { oAuth } oAuth - Your oAuth tokens
	 */
